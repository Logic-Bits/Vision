(function() {
    ...
    angular
        .module('app')
        .controller('scDetails', DetailsController)
        .controller('Qm.UseCasesController', Controller);

    function DetailsController($scope, UseCaseService) {

        $scope.duplicateUseCase = duplicateUseCase;
        $scope.updateUseCase = updateUseCase;
